...
m_w = np.zeros(n);  V_p = V_p0.copy();  r_p = r0.copy();  m_p = m_p0.copy()
...
ax.set_title("Multi-particle macroscopic swelling")
ax.legend()
ax.grid(True)
plt.tight_layout()
plt.savefig("multi_particle_macroscopic_swelling.pdf")
plt.show()
